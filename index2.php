...
if(!isset($error_message)) {
	...
	if(!isset($error_message)) {
		...
		$query = "INSERT INTO registered_users (first_name,last_name,email,gender,age,bloodgroup,phoneno,address) VALUES
		('" . $_POST["firstName"] . "', '" . $_POST["lastName"] . "', '" . $_POST["userEmail"] . "', '" . $_POST["gender"] . "', '" . $_POST["age"] . "', '" . $_POST["bloodgroup"] . "', '" . $_POST["phoneno"] . "', '" . $_POST["address"] . "')";
...
<tr>
<td>Phone No.</td>
<td><input type="text" class="demoInputBox" name="phoneno" value="<?php if(isset($_POST['phoneno'])) echo $_POST['phoneno']; ?>"></td>
</tr>
